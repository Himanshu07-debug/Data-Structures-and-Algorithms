...
// This is Simple Dijsktra ---> dist == maxAbs

// How we are sure that ki first time pe jo dest pq.top() pe aayenga to uski dist[] value min. max Absolute diff path ki hai ???
