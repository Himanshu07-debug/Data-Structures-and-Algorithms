...
// the frog was allowed to jump either one or two steps at a time. In this question, the frog is allowed to jump up 
// to ‘K’ steps at a time. If K=4, the frog can jump 1,2,3, or 4 steps at every index.

// We have to think only for the modifications.
...
// SPACE OPTIMIZATION -> It is Possible, but not Recommended, becz it will be TDS to keep track of K variables 
//                       and the constraints of K is also long
